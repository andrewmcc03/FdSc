<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        (
            ...
            $_SESSION['noDefects'],
            $_SESSION['remarks'],
            $_SESSION['reportingDriver'],
            $_SESSION['reportingDriverDate'],
            $_SESSION['reportingDriverEmpNo'],
            $_SESSION['reviewingDriver'],
            $_SESSION['reviewingDriverDate'],
            $_SESSION['reviewingDriverEmpNo'],
            $_SESSION['maintenanceDate'],
            $_SESSION['roNumbers'],
            $_SESSION['certifiedBy'],
            $_SESSION['maintenanceLocation'],
            $_SESSION['repairsNeeded'],
            $_SESSION['shopRemarks']
        );
